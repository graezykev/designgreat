...
For technical details about font formats, subsetting, and architectural decisions, see [Font Assets in Contributing Docs](/contributing/design-tokens-development/font-assets).
:::
...
- Check the [Component Library Font Setup](/components/guides/font-setup) guide
