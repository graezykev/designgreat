...
- e289759: Reorganize gradient generation algorithm documentation and update input border examples

  **Changes:**
  - Moved "Gradient Generation Algorithm" section from Accent Colors page to Core Concepts &
    Theme-Awareness page
  - Placed algorithm explanation immediately after "Fixed Gradient Levels" section for better
    logical flow
...
- Updated dependencies [3e10a39]
  - @designgreat/lib-design-token@0.10.1
  - @designgreat/lib-web-component@0.7.7
