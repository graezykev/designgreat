...
**🎯 Getting Started** — _Understand the fundamentals_
...
**🔍 Deep Dive** — _Learn how it works_
...
**⚡ Practical Guide** — _Start using it_

- [Usage Guidelines](#usage-guidelines) — Do's, don'ts, and common mistakes
- [Usage Examples](#usage-examples) — Copy-paste ready code snippets

**🛠️ Reference** — _Technical details and resources_

- [Technical Details](#technical-details) — CSS implementation and specificity
- [Related](#related) — Additional documentation
...
:::info Grey vs Neutral
**`grey`** and **`neutral`** have identical values. `neutral` is a semantic alias for `grey`, making it interchangeable in your code. Use whichever name fits your context:

- `color.accent.grey.5` = `color.accent.neutral.5` (same color)
- Shortcut tokens (like `color.text`, `color.background`) use `neutral` internally
  :::
...
| ------------------ | --------------------------- | ---------------------- | ---------------------- | --------------------------------------------------------------------------------------------------- | ----------- |
| **Base Color**     | `color.base.blue`           | `#0055cc`              | `#0055cc`              | <div className="color-demo" style={{backgroundColor: 'var(--dg-color-base-blue)'}}></div>           | ✅ SAME     |
| **Fixed Level**    | `color.accent.grey.1`       | `#ffffff`              | `#ffffff`              | <div className="color-demo" style={{backgroundColor: 'var(--dg-color-accent-grey-1)'}}></div>       | ✅ SAME     |
| **Fixed Level**    | `color.accent.grey.12`      | `#0c0c0d`              | `#0c0c0d`              | <div className="color-demo" style={{backgroundColor: 'var(--dg-color-accent-grey-12)'}}></div>      | ✅ SAME     |
| **Semantic Alias** | `color.accent.grey.silent`  | `#ffffff` (→ level 1)  | `#0c0c0d` (→ level 12) | <div className="color-demo" style={{backgroundColor: 'var(--dg-color-accent-grey-silent)'}}></div>  | 🔄 SWITCHED |
| **Semantic Alias** | `color.accent.grey.bold`    | `#0c0c0d` (→ level 12) | `#ffffff` (→ level 1)  | <div className="color-demo" style={{backgroundColor: 'var(--dg-color-accent-grey-bold)'}}></div>    | 🔄 SWITCHED |
| **Semantic Alias** | `color.accent.blue.DEFAULT` | `#0055cc` (→ level 7)  | `#3388ff` (→ level 4)  | <div className="color-demo" style={{backgroundColor: 'var(--dg-color-accent-blue-default)'}}></div> | 🔄 SWITCHED |
...
<svg
  ...
  style={{ maxWidth: '900px', margin: '2rem auto', display: 'block' }}
>
  <defs>
...
<g id="gradient-levels">
  <text x="450" y="55" textAnchor="middle" fontSize="11" fontWeight="600" fill="#999">
    FIXED GRADIENT LEVELS
  </text>
  {[
    ...
    <g key={level}>
      ...
      <text x="450" y={y + 25} textAnchor="middle" fontSize="13" fontWeight="600" fill={text}>
        grey.{level}
      </text>
    </g>
  ))}
...
<g id="light-aliases">
  <text x="20" y="55" fontSize="11" fontWeight="600" fill="#999">
    ☀️ LIGHT THEME
  </text>
  {[
    ...
    return (
      <g key={name}>
        <path
          d={`M 25 ${y} L 120 ${y} L 120 ${y + 40} L 25 ${y + 40} L 20 ${y + 20} Z`}
...
<g id="dark-aliases">
  <text x="860" y="55" fontSize="11" fontWeight="600" fill="#999" textAnchor="end">
    🌙 DARK THEME
  </text>
  {[
    ...
    return (
      <g key={name}>
        <path
          d={`M 780 ${y} L 875 ${y} L 880 ${y + 20} L 875 ${y + 40} L 780 ${y + 40} Z`}
          fill={isDefault ? '#f3f4f6' : '#e5e7eb'}
          stroke={type === 'bg' ? '#d1d5db' : '#374151'}
          strokeWidth={type === 'bg' ? '1' : isDefault ? '2.5' : '2'}
        />
        ...
        <path
          d={`M ${780} ${y + 20} Q ${650} ${(y + targetY) / 2} ${535} ${targetY + 20}`}
          stroke="#555"
          strokeWidth="2"
          fill="none"
          markerEnd="url(#arrow)"
...
{/* Legend */}
  ...
  <g>
    <path
      d="M 325 685 L 435 685 L 440 697.5 L 435 710 L 325 710 L 320 697.5 Z"
      fill="#e5e7eb"
      stroke="#374151"
      strokeWidth="2"
    />
    <text x="380" y="702" textAnchor="middle" fontSize="11" fontWeight="600" fill="#374151">
      foreground
    </text>

    <path
      d="M 455 685 L 555 685 L 560 697.5 L 555 710 L 455 710 L 450 697.5 Z"
      fill="#e5e7eb"
      stroke="#d1d5db"
      strokeWidth="1"
    />
    <text x="505" y="702" textAnchor="middle" fontSize="11" fontWeight="600" fill="#374151">
      background
    </text>
...
{/* Legend */}
  ...
  <g>
    <path
      d="M 325 585 L 435 585 L 440 597.5 L 435 610 L 325 610 L 320 597.5 Z"
      fill="#e5e7eb"
      stroke="#374151"
      strokeWidth="2"
    />
    <text x="380" y="602" textAnchor="middle" fontSize="11" fontWeight="600" fill="#374151">
      foreground
    </text>

    <path
      d="M 455 585 L 555 585 L 560 597.5 L 555 610 L 455 610 L 450 597.5 Z"
      fill="#e5e7eb"
      stroke="#d1d5db"
      strokeWidth="1"
    />
    <text x="505" y="602" textAnchor="middle" fontSize="11" fontWeight="600" fill="#374151">
      background
    </text>
...
.logo {
  fill: var(--dg-color-accent-blue-7);
}
```
...
.card {
  background: var(--dg-color-accent-neutral-dull);
} /* Subtle layer */
.section {
  background: var(--dg-color-accent-neutral-low);
} /* More visible layer */
...
.text {
  color: var(--dg-color-accent-grey-11);
}
...
<h1 style={{ color: 'var(--dg-color-accent-neutral-bold)' }}>Heading</h1>
```
...
const themeAwareStyles = {
  heading: {
    color: tokens.color.accent.neutral.bold // Switches between themes
  },
  card: {
    backgroundColor: tokens.color.accent.neutral.silent, // Switches between themes
    color: tokens.color.accent.neutral.DEFAULT // Switches between themes
  }
}

// Fixed color usage (for logos, brand elements)
const fixedStyles = {
  logo: {
...
- [Usage Guidelines](#usage-guidelines) for choosing the right alias level
...
- [Accent Colors](./accent-colors) - Gradient palette and semantic aliases
- [Base Colors](./base-colors) - Foundation seed colors
- [Primary & Brand Colors](./primary-brand-colors) - Theme-aware brand colors
- [Semantic Colors](./semantic-colors) - Contextual colors that adapt
- [Shortcut: Text Colors](./shortcuts/text) - Ready-to-use text colors
- [Shortcut: Background Colors](./shortcuts/background) - Ready-to-use backgrounds

### Implementation Guides

- [Theming Guide](../guides/theming) - Toggle themes programmatically
- [Basic Usage](../guides/basic-usage) - How themes are generated
- [Tailwind Integration](../guides/tailwind) - Using with Tailwind CSS
...
| -------------------------------------------------- | ------------------- | --------------------------------------------------------------------------- | ----------------------------- |
| **[Base Colors](./base-colors)**                   | ✅ Always Fixed     | `color.base.blue`, `color.base.red`, `color.base.grey`                      | Brand identity, logos         |
| **[Fixed Gradient Levels](./accent-colors)**       | ✅ Always Fixed     | `color.accent.grey.1-12`, `color.accent.blue.1-10`, `color.accent.red.1-10` | Data viz, consistent colors   |
| **[Semantic Aliases](./accent-colors)**            | 🔄 Theme-Switchable | `bold`, `DEFAULT`, `subtle`, `low`, `dull`, `silent`                        | UI text, backgrounds, borders |
| **[Primary/Brand Colors](./primary-brand-colors)** | 🔄 Theme-Switchable | `color.primary.DEFAULT`, `color.brand`                                      | Buttons, interactive elements |
| **[Semantic Colors](./semantic-colors)**           | 🔄 Theme-Switchable | `color.semantic.info.DEFAULT`, `color.semantic.success.DEFAULT`             | Alerts, feedback messages     |
