...
| -------------------------------------------------- | ------------------- | ---------------------------------------------------- | ----------------------------- |
| **[Base Colors](./base-colors)**                   | ✅ Always Fixed     | `base.blue`, `base.red`, `base.grey`                 | Brand identity, logos         |
| **[Fixed Gradient Levels](./accent-colors)**       | ✅ Always Fixed     | `grey.1-12`, `blue.1-10`, `red.1-10`                 | Data viz, consistent colors   |
| **[Semantic Aliases](./accent-colors)**            | 🔄 Theme-Switchable | `bold`, `DEFAULT`, `subtle`, `low`, `dull`, `silent` | UI text, backgrounds, borders |
| **[Primary/Brand Colors](./primary-brand-colors)** | 🔄 Theme-Switchable | `primary.DEFAULT`, `brand.emphasis`                  | Buttons, interactive elements |
| **[Semantic Colors](./semantic-colors)**           | 🔄 Theme-Switchable | `semantic.info`, `semantic.success`                  | Alerts, feedback messages     |
