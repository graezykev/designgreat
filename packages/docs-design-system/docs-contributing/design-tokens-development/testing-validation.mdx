...
cat packages/lib-web-ui-design-token/dist/css/light/variables.css
cat packages/lib-web-ui-design-token/dist/css/dark/variables.css

# Check TypeScript exports
cat packages/lib-web-ui-design-token/src/generated/themes.ts
```
