...
The `@designgreat/lib-web-ui-design-token` package owns and distributes font assets:
...
When importing `@designgreat/lib-web-ui-design-token/font`:
...
The `@designgreat/lib-web-ui` component library does **NOT** include fonts for these reasons:
...
See [Component Library Font Handling](/contributing/component-library-development/font-handling) for implementation details.
...
- [Font Integration (User Guide)](/docs/tutorial/font-integration) - How to use fonts
- [Build System](/contributing/design-tokens-development/build-system) - Font download process
- [Development Workflow](/contributing/design-tokens-development/development-workflow) - Working with fonts during development
