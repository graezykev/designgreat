...
| `./brand/*` | Assets | Brand assets (logo, etc.) |

### CLI Commands (bin)

| Command | Description |
|---------|-------------|
| `dg-copy-brand` | Copy brand assets to destination |
| `dg-copy-fonts` | Copy font assets to destination |
| `dg-copy-all` | Copy all assets to destination |

See [Build System](./build-system#cli-commands) for usage details.

### Published Files

- `dist/` — JS, CSS, fonts, CLI, and TypeScript definitions
