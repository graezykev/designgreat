...
```json
{
  ...
  "bin": {
    "dg-copy-brand": "./dist/cli/copy-brand.js",
    "dg-copy-fonts": "./dist/cli/copy-fonts.js",
    "dg-copy-all": "./dist/cli/copy-all.js"
  }
}
```
...
The package also exports CLI commands for copying assets:

```bash
dg-copy-brand ./public      # Copy brand assets
dg-copy-fonts ./static/font # Copy font assets
dg-copy-all ./static        # Copy all assets
```

See [Build System](./build-system#cli-commands) for details.
