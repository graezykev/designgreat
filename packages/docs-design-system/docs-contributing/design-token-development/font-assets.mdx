...
│   └── cli/
│       └── copy-fonts.js    # CLI: dg-copy-fonts
└── package.json:
    exports: "/font" → "./dist/font/font-face.css"
    bin: dg-copy-fonts → "./dist/cli/copy-fonts.js"
```
...
Use the `dg-copy-fonts` CLI to copy font assets to your project:
...
```json
{
  "scripts": {
    ...
    "build": "pnpm run copy:fonts && your-build-command"
  }
}
```
...
- [Token Authoring](./token-authoring) — Creating and modifying tokens
