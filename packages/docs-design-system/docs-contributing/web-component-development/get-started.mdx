...
- **PNPM** 9 or higher
- **Git**
- **`@designgreat/lib-design-token`** (workspace dependency)
...
**What happens:**
1. Fonts are copied from `lib-design-token/dist/font/` to `public/assets/fonts/`
...
```bash
pnpm --filter @designgreat/lib-web-component generate:theme
```
