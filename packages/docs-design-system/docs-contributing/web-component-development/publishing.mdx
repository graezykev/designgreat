...
```json
{
  "name": "@designgreat/lib-web-component",
  "version": "x.x.x",
  "main": "./dist/index.cjs",
  ...
  "exports": {
    ...
    "./dist/lib-web-component.css": "./dist/lib-web-component.css"
  }
}
```
...
- **`./dist/lib-web-component.css`** - Complete CSS bundle
...
```
dist/
└── lib-web-component.css           # Complete CSS bundle
```
