...
```
┌────────────────────────────────┐
│ lib-design-token build  │ ← Design token package
...
└───────────────┬────────────────┘
                ...
                ▼
┌────────────────────────────────┐
│ lib-web-component generate:theme│ ← This package
...
During development, you may need to regenerate tokens after changes to `lib-design-token`:
