...
The `@designgreat/lib-web-component` library **intentionally does NOT bundle fonts** in its distributable CSS. This design decision provides several benefits:
...
The distributed CSS (`dist/lib-web-component.css`) does **NOT** include:
