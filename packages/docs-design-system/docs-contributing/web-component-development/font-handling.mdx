...
```
Consumer App
  ├─> @designgreat/lib-web-ui-design-token/font (optional)
  └─> @designgreat/lib-web-ui
       └─> src/index.ts
            └─> styles/index.css
                 ├─> @designgreat/lib-web-ui-design-token/css (tokens)
                 └─> tailwind.css
                      ├─> @tailwind utilities
                      └─> components.css
```
...
import '@designgreat/lib-web-ui-design-token/font' // Fonts for preview
...
src/index.ts
  └─> styles/index.css
       ├─> @designgreat/lib-web-ui-design-token/css  (tokens only)
       └─> tailwind.css
            ├─> @tailwind utilities
            └─> components.css
...
```
.storybook/preview.tsx
  ├─> @designgreat/lib-web-ui-design-token/font  (fonts - Storybook only)
...
- Choose your font loading strategy (see [Font Setup Guide](/web-component/guides/font-setup))
