...
const CodeDemoToggle = ({ code, children }: CodeDemoToggleProps) => {
...
const ToggleButton = ({ active, label, onClick, themeVariant }: ToggleButtonProps) => {
...
const renderWithCodeToggle = (code: string) => (args: ButtonProps) => (
  <CodeDemoToggle code={code}>
    <Button {...args} />
  </CodeDemoToggle>
)
